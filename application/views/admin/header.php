        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-examplenavbar-collapse-1">
                <ul class="nav navbar-nav">
                    <li class="active"><a href="<?php echo base_url() . 'admin'; ?>"> Dashboard <span class="sronly">(current)</span></a></li>
                    <li><a href="<?php echo base_url() . 'admin/mobil'; ?>"> Data Mobil</a></li>
                    <li><a href="<?php echo base_url() . 'admin/kostumer'; ?>">Data Kostumer</a></li>
                    <li><a href="<?php echo base_url() . 'admin/transaksi'; ?>"> Transaksi Rental</a></li>
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li> <a href="<?php echo base_url() . 'admin/ganti_password' ?>">
                                    <i class="glyphicon glyphiconlock"></i> Ganti Password</a>
                            </li>
                        </ul>
                    </li>
                </ul>
