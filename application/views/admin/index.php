        ...
        <div class="panel panel-success">
            <div class="panel-heading">
                <div class="row">
                    ...
                    <div class="col-xs-9 text-right">
                        <div class="huge">
                            <?php echo $this->M_rental->get_data('kustomer')->num_rows(); ?>
                        </div>
            ...
            <div class="panel-body">
                <div class="list-group">
                    <?php foreach ($kostumer as $k) { ?>
                        <a href="#" class="list-group-item">
                            <span class="badge"><?php echo $k->kustomer_JK ?></span>
                            <i class="glyphicon glyphicon-user"></i> <?php echo $k->kustomer_nama; ?>
                        </a>
                    <?php } ?>
                </div>
                <div class="text-right">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?php echo date('d/m/Y', strtotime($t->transaksi_TGLdikembalikan)); ?></td>
